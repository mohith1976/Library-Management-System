...
public class books{
    ...
    public int compareBookObjects(book b1, book b2)
    {
        ...
        if(b1.sNo == b2.sNo)
        {
            System.out.println("This Book Number already exists ");
            return 0;
        }
    ...
    {
        System.out.println("Search by Serial Number of the Book");
    ...
    public void upgradeBookQty()
    {
        ...
        for(int i=0;i<count;i++)
        {
            if(sNo == theBooks[i].sNo)
            {
                System.out.println("Enter the quantity needs to be added");
